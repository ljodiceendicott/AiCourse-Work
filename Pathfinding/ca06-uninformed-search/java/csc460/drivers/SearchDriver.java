...
public class SearchDriver implements Driver {
    ...
    public boolean step(){
        ...
        if(problem.isGoal(searchNode.state)){
            ...
            //   States expanded: ...
            System.out.println("num States expanded:"+this.algorithm.getNumStatesExpanded());
            //   Max fringe size: ...
            System.out.println("MAX FRINGE: "+this.algorithm.getMaxFringeSize());
            //   Solution cost: ...
            System.out.println("Cost"+searchNode.cost);
            //   Solution path length: ...
            System.out.println("Path length"+ searchNode.pathActions.size());
            //   Solution path (actions):
            System.out.println("Actions:");
                for(int i =0; i<searchNode.pathActions.size(); i++){
                    System.out.println(i+1+" "+searchNode.pathActions.get(i));
                }
            //     ...
            //     ...
