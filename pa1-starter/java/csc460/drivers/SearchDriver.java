...
public class SearchDriver implements Driver {
    ...
    public boolean step(){
        ...
        // This should happen if there is no solution (the entire state space 
        // has been explored).
        if(searchNode == null){
            return false;
        }
    ...
    public static void main(String[] args){
        ...
        String usage = "Usage: SearchDriver [options]\n\n"+
            ...
            "             * catMaze(retrieve all 'pellets', then find the exit)\n"+
            ...
            "             [space] -- an open spot where the agent is allowed to enter cost 1\n"+
            "             Catmaze: has same items as regular maze with some extra added"+
            "             h -- the hazards going in these spaces cost 5 \n"+
            "             m -- 'pellots', all of these need to be picked up before the agent needs to be at the exit\n"+
            "OPTIONAL arguments\n"+
            ...
            "            for p=catmaze\n"+
            "            eap -- 'eat all pellets' - the agent keeps moving toward the nearest 'pellet' until there are no more and it goes toward exit \n"+
            "            dte -- 'distance to end' - the agent knows how far it needs to go until it is allowed to reach the exit\n"+
            ...
            "             default is 5\n"+
            "\n\n";
            /*Make sure that the args length is equal to the proper length including at least: 
            -search problem; p-
            -size; s-
            -search algo a-
            -file name f-
        ...
        for(String arg : args){
            ...
            if(arg.startsWith("-p=")){
                ...
                else if(problemCode.equals("catmaze")){
                    searchProblem = new CatMaze();
                }
                // Invalid option.
                else {
